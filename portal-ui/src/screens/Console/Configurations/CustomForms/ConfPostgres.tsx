    ...
    <Grid container>
            ...
            <Grid item xs={12} className={classes.configureString}>
              ...
              <Grid item xs={12}>
                <SelectWrapper
                  ...
                  options={[
                    { label: t("enterSSLMode"), value: " " },
                    { label: t("require"), value: "require" },
                    { label: t("disable"), value: "disable" },
                    { label: t("verifyCA"), value: "verify-ca" },
                    { label: t("verifyFull"), value: "verify-full" },
                  ]}
                />
              </Grid>
              <Grid item xs={12}>
      ...
      <Grid item xs={12}>
        <InputBoxWrapper
          ...
          name="queue_dir"
          label={t("queueDir")}
          placeholder={t("enterQueueDir")}
          value={queueDir}
          tooltip={t("queueDirTooltip")}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      <Grid item xs={12}>
        <InputBoxWrapper
          ...
          name="queue_limit"
          label={t("queueLimit")}
          placeholder={t("enterQueueLimit")}
          type="number"
          value={queueLimit}
          tooltip={t("queueLimitTooltip")}
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
